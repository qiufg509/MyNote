...
if %errorlevel% equ 0 (
	for /f "tokens=1-9 delims=_." %%i IN ('dir %USERPROFILE%\Desktop\output /b') do ren %USERPROFILE%\Desktop\output\%%i_%%j.%%k.%%l__%%m_%%n_%%o_%%p.%%q %%i_%%j.%%k.%%l_%%p_%date:~0,4%%date:~5,2%%date:~8,2%-%time:~0,2%%time:~3,2%%time:~6,2%_%%m.%%q
) else (
	for /f "tokens=1-9 delims=_." %%i IN ('dir %USERPROFILE%\Desktop\output /b') do ren %USERPROFILE%\Desktop\output\%%i_%%j.%%k.%%l_%%m_%%n_%%o_%%p.%%q %%i_%%j.%%k.%%l_%%p_%date:~0,4%%date:~5,2%%date:~8,2%-%time:~0,2%%time:~3,2%%time:~6,2%_%%m.%%q
)
goto :eof
